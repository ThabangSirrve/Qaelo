<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrivacyPolicy.aspx.cs" Inherits="Qaelo.Web.Account.PrivacyPolicy" %>
...
<body>
    ...
    <div class="card-block">
        <!--Title-->
        <h4 class="card-title">PRIVACY POLICY <a href="tempLogin.aspx" style="background:#d89b4e" class="btn pull-right">Login</a>  </h4>
        <!--Text--><br />
...
<br /><br />
       ...
       We may share information with governmental agencies or other companies assisting us in fraud prevention or investigation. We may do so when: (1) permitted or required by law; or, (2) trying to protect against or prevent actual or potential fraud or unauthorized transactions; or, (3) investigating fraud which has already taken place. Your personal information will not be sold or shared for marketing purposes.
<br /><br />
