<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Users/Student/Student.Master" AutoEventWireup="true" CodeBehind="freelancers.aspx.cs" Inherits="Qaelo.Web.Users.Student.freelancers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class='col-md-12 thumbnail'>
	        <div class="col-md-12">
                  <h3 class="text-center">Find your freelancer!</h3>
  ...
  <div class="row" id="divContent" runat="server">
          ...
          <div class="col-sm-4">                                  
                                      <div class="form-group col-sm-offset-1"  id="DivDefault" visible="true" runat="server">
          ...
          <div class="col-sm-4">
              <div class="form-group">
                                                <label>Freelancer</label>
                                                  <asp:DropDownList ID="ddlWork1" Width="100%" CssClass="form-control" AutoPostBack="true" runat="server" >
