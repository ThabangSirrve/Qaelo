<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Users/EventPoster/EventPoster.Master" AutoEventWireup="true" CodeBehind="EditProfile.aspx.cs" Inherits="Qaelo.Web.Users.EventPoster.EditProfile1" %>
                                  ...
                                  <div class="col-sm-6">
                                      <div class="form-group">
                                        <label>FullName <small>(required)</small></label>
                                          <asp:TextBox ID="txtFullName" name="firstname" type="text" class="form-control" placeholder="My name is..." runat="server"></asp:TextBox>
                                      </div>
                                          <div class="form-group">
                                    ...
                                    <div class="col-sm-7 col-sm-offset-2">
                                         <div class="form-group">
                                            <%--<label>Confirm Password</label>--%>
                                             <asp:Button ID="Button2" class="btn btn-info pull-right" runat="server" Text="update" OnClick="btnUpdate_Click" />
                                          </div>
                                    </div>
                                </div>
                            <!-- Content here-->
