<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditRoom.aspx.cs" Inherits="Qaelo.Web.Users.Accommodation.EditRoom" %>
                ...
                <!--        You can switch "ct-wizard-azzure"  with one of the next bright colors: "ct-wizard-blue", "ct-wizard-green", "ct-wizard-orange", "ct-wizard-red"             -->
                        ...
                        <div class="tab-content">
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-sm-5">
                                      <div class="form-group">
                                          ...
                                          <div class="input-group">
                                              <asp:TextBox ID="txtDistance" class="form-control" placeholder="Distance" runat="server"></asp:TextBox>
                            ...
                            <div class="tab-pane" id="type">
                                <h4 class="info-text">Please upload 5 images of the room available</h4>
                                <div class="row">
                            ...
                            <div class="tab-pane" id="facilities">
                                <h4 class="info-text">Tell us more about the accommodation. </h4>
                                <div class="row">
                                  <div class="col-sm-5 col-sm-offset-1">
                                      <div class="form-group">
                                          <label>Is the accomodation NSFAS Accredited?</label>
                                  ...
                                  <div class="col-sm-5 ">
                                      <div class="form-group">
                                          ...
                                          <div class="input-group">
                                              ...
                                              <asp:TextBox ID="txtPrice" class="form-control" placeholder="Rent per month" runat="server"></asp:TextBox>
                                          </div>
                                      </div>
                                  </div>
                            ...
                            <div class="tab-pane" id="description">
                                <div class="row">
                                    <h4 class="info-text">Small description about the property. </h4>
