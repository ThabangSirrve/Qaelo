<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Users/Student/template.Master" AutoEventWireup="true" CodeBehind="students-edit-books.aspx.cs" Inherits="Qaelo.Web.Users.Student.students_edit_books" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Edit your textbook</title>
                 ...
                 <li><a class="disabled">
                     ...
                     <div class="tab-content">
                      <div class="tab-pane fade in active" id="home">
                              <h3 class="head text-center">Sell your texbook</h3>
                        ...
                        <!-- Content here-->
                                    ...
                                    <div class="col-sm-4 col-sm-offset-1">
                                      ...
                                      <h6 class="">Book Image</h6>
                                       <img src="../../../Images/Book/default.jpg" class="img-thumbnail" style="height:230px;width:80%" runat="server" id="image1"/>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 style="margin-right:50px">Tell friend</h4>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>						
									<p>Please Tell 3 a friends that that you are publishing your used textbook with us, Who knows? They may just buy or tell other friends about you</p>
                                </div>
							</div>
							<section>
								<div class="modal-body"><br />
                                <div class="form-group">
                                    <label>1. Friend's email</label>
                                    <asp:TextBox ID="txtshare1" CssClass="form-control" placeholder="Email" runat="server"></asp:TextBox><br />
                                </div>
                                 <div class="form-group">
                                    <label>2. Friend's email</label>
                                    <asp:TextBox ID="txtshare2" CssClass="form-control" placeholder="Email" runat="server"></asp:TextBox><br />
                                </div>
                                 <div class="form-group">
                                    <label>3. Friend's email</label>
                                    <asp:TextBox ID="txtshare3" CssClass="form-control" placeholder="Email" runat="server"></asp:TextBox><br />
                                </div>
								</div>
                          ...
                          <p class="text-center" >
                           ...
                           <a href="#doner" data-toggle="tab" style="margin-top:-15px"  class="btn btn-success btn-outline-rounded green"> Next <span style="margin-left:10px;" class="glyphicon glyphicon-forward"></span></a>
                          </p>
                      ...
                      <div class="tab-pane fade" id="doner">
                        ...
                        <h3 class="head text-center">Save your book updates</h3>
                          <p class="text-center">
