<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Users/Student/Student.Master" AutoEventWireup="true" CodeBehind="Accommodation.aspx.cs" Inherits="Qaelo.Web.Users.Student.Accommodation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container thumbnail">
	    <div class="row">
	        <div class="col-md-12"> 
	          <h3 class="text-center">Find your accommodation!</h3>
              <hr/>
            </div>
            <div class="col-md-12">
              <div class="col-sm-6">
