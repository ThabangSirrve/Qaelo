<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Post.aspx.cs" Inherits="Qaelo.Web.Users.Company.Post" %>
                ...
                <!--        You can switch "ct-wizard-orange"  with one of the next bright colors: "ct-wizard-blue", "ct-wizard-green", "ct-wizard-orange", "ct-wizard-red"             -->
                        ...
                        <div class="tab-content">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <label>Post Type</label>
                                          ...
                                          <div class="col-sm-12">
                                              ...
                                              <asp:TextBox ID="txtCDate" name="Closing Date" type="date" class="form-control" placeholder="5 Jan 2017" runat="server"></asp:TextBox>
                                          </div>
                                         </div>
                                  </div>
                              </div>
                            ...
                            <div class="tab-pane" id="account">
                                    ...
                                    <div class="col-sm-6 col-sm-offset-3">
                                         <div class="form-group">
                                           <label>Enter the Job/Bursary description. </label>
                            ...
                            <div class="tab-pane" id="address">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h4 class="info-text"> Postal Address/Email/Fax</h4>
                                    </div>
                                    <div class="col-sm-6 col-sm-offset-3">
                                         <div class="form-group">
