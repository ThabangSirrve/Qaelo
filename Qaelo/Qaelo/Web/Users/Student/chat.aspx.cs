            ...
            if (!IsPostBack)
            {
                if (Session["STUDENT"] != null)
                {
                    ...
                    foreach (var chat in chats)
                    {
                        ...
                        chatList += string.Format(@"<div class='chat_list {4}'><a href='chat.aspx?id={3}'>
                    ...
                    {
                        string letter = Request.QueryString["chatTo"].ToString()[0].ToString();
                        ...
                        chatList += string.Format(@"<div class='chat_list active_chat'><a href='chat.aspx?id={3}'>
                          <div class='chat_people'>
                            <div class='chat_img'> <img src='../../../Images/Profile/defaultProfilePic.jpg'/> </div>
                            <div class='chat_ib'>
                              <h5>{0}<span class='chat_date'>{1}</span></h5>
                ...
                {
                    Response.Redirect("~/Web/Account/tempLogin.aspx?page=Users/Student/chat.aspx");
                }
