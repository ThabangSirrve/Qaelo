<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListShop.aspx.cs" Inherits="Qaelo.Web.Users.Shop.ListShop" %>
                ...
                <!--        You can switch "ct-wizard-azzure"  with one of the next bright colors: "ct-wizard-blue", "ct-wizard-green", "ct-wizard-orange", "ct-wizard-red"             -->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="type">
                                <h4 class="info-text">Please upload  image for the shop</h4>
                                <div class="row">
                            ...
                            <div class="tab-pane" id="description">
                                <div class="row">
                                    <h4 class="info-text">Small description about the shop. </h4>
