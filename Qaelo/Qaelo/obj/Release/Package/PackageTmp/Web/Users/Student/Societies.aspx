<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Users/Student/Student.Master" AutoEventWireup="true" CodeBehind="Societies.aspx.cs" Inherits="Qaelo.Web.Users.Student.Societies" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	    ...
	    <div class="row">
	        <div class="col-md-12"> 
	          <h3 class="text-center">Find your student society!</h3>
              <hr/>
            </div>
            <div class="col-md-12">
              <div class="col-sm-6">
