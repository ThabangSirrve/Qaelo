<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Users/Shop/Shop.Master" AutoEventWireup="true" CodeBehind="discount.aspx.cs" Inherits="Qaelo.Web.Users.Facility.discount" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Create a discount</title>
    <!-- checkboxes-->
                 ...
                 <li><a href="#messages" data-toggle="tab" >
                     ...
                     <div class="tab-content">
                      <div class="tab-pane fade in active" id="home">
                              <h3 class="head text-center">Create a Discount</h3>
                                     ...
                                     <div class="col-sm-5 col-sm-offset-1">
                                      <div class="form-group">
                                          ...
                                          <div class="input-group">
                                              ...
                                              <asp:TextBox ID="txtShoNo" type="text" class="form-control"  placeholder="Address" runat="server"></asp:TextBox>
                                          </div>
                                      </div>
                                  </div>
                              ...
                              <p class="text-center">
                                  <a href="#profile" data-toggle="tab" class="btn btn-success btn-oFutline-rounded green"> Next <span style="margin-left:10px;" class="glyphicon glyphicon-forward"></span></a>
                              </p>
                      </div>

                      <div class="tab-pane fade" id="profile">
                          <h3 class="head text-center">Discount Image</h3>
                          <p class="narrow text-center">
                      ...
                      <div class="tab-pane fade" id="messages">
                              <h3 class="head text-center" style="margin-top:-20px">Small description about the Discount.</h3>
                          <div class="row">
                                    ...
                                    <div class="col-sm-6 col-sm-offset-3">
                                         <div class="form-group">
                                            <label>Discount's description</label>
                      ...
                      <div class="tab-pane fade" id="settings">
                          <h3 class="head text-center">Cost of the Discount</h3>
                            <%--                          <p class="narrow text-center">
                          ...
                          <div class="row">
                              <div class="col-sm-6 col-sm-offset-3">
                                <div class="form-group">
                              <label>Discount's Name</label>             
                              <asp:TextBox ID="txtName" class="form-control" placeholder="Name of Discount your are offering"  runat="server" Width="100%" ></asp:TextBox>     
                                       </div>
                                  </div>
                      ...
                      <div class="tab-pane fade" id="doner">
                        ...
                        <h3 class="head text-center">Save your Discount</h3>
                          <p class="text-center">
