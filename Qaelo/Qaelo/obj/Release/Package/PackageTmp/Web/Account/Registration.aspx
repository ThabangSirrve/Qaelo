...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <div class="form">
      ...
      <asp:DropDownList id="ddlUser" runat="server" AutoPostBack="true" CssClass="dropdownlist">
          <asp:ListItem Value="NONE" disabled="" Selected="">Please Select Account</asp:ListItem>
          <asp:ListItem Value="Student">Student Freelancer</asp:ListItem>
          <asp:ListItem Value="Property">Property Owner</asp:ListItem>
          <asp:ListItem Value="Shop">Shop Owner</asp:ListItem>
          <asp:ListItem Value="Event">Event Poster</asp:ListItem>
          <asp:ListItem Value="Company">Company HR</asp:ListItem>
          <asp:ListItem Value="Society">Student Society</asp:ListItem>
      </asp:DropDownList>
      ...
      <p class="message">By clicking "Create" I agree to Qaelo's <a href="TermsOfUse.aspx" target="_blank">Terms of Service</a> and <a href="PrivacyPolicy.aspx" target="_blank">Privacy Policy</a></p>
      <p class="message">Already registered? <a href="Login.aspx">Sign In</a><a href="../../index.html" class="pull-right">Home</a></p><br />
