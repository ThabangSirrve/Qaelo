<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Users/Shop/Shop.Master" AutoEventWireup="true" CodeBehind="edit-facility.aspx.cs" Inherits="Qaelo.Web.Users.Facility.edit_facility" %>
                 ...
                 <li><a href="#messages" data-toggle="tab" >
                     ...
                     <div class="tab-content">
                      <div class="tab-pane fade in active" id="home">
                              <h3 class="head text-center">Update Facility</h3>
<%--                              <p class="narrow text-center">
                          ...
                          <div class="row">
                                       ...
                                       <div class="col-sm-7  col-sm-offset-1">
                                           ...
                                           <div class="col-sm-3">
                                             <asp:DropDownList ID="ddlYear" Width="100%" CssClass="form-control col-sm-3" runat="server" >
                                     ...
                                     <div class="col-sm-5 col-sm-offset-1">
                                      <div class="form-group">
                                          ...
                                          <div class="input-group">
                                              ...
                                              <asp:TextBox ID="txtShoNo" type="text" class="form-control"  placeholder="Facility number" runat="server"></asp:TextBox>
                                          </div>
                                      </div>
                                  </div>
