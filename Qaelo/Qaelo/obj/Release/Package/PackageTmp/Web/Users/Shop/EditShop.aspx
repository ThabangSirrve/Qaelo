<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditShop.aspx.cs" Inherits="Qaelo.Web.Users.Shop.EditShop" %>
                ...
                <!--        You can switch "ct-wizard-azzure"  with one of the next bright colors: "ct-wizard-blue", "ct-wizard-green", "ct-wizard-orange", "ct-wizard-red"             -->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="description">
                                <div class="row">
                                    <h4 class="info-text">Small description about the Special. </h4>
                        ...
                        <div class="wizard-footer">
                                ...
                                <div class="">
                                    <input type='button' class='btn btn-previous btn-fill btn-default btn-wd btn-sm pull-left' name='previous' value='Previous' />
                                    <asp:Button ID="btnFinish" runat="server" Text="Finish" type='button' class='btn btn-finish btn-fill btn-success btn-wd btn-sm pull-right' OnClick="btnFinish_Click"/>
                                </div>
