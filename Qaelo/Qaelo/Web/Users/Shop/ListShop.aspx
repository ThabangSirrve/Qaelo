<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Users/Shop/Shop.Master" AutoEventWireup="true" CodeBehind="ListShop.aspx.cs" Inherits="Qaelo.Web.Users.Shop.ListShop1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>List a shop</title>
                 ...
                 <li><a href="#messages" data-toggle="tab" >
                     ...
                     <div class="tab-content">
                      <div class="tab-pane fade in active" id="home">
                              <h3 class="head text-center">List shop</h3>
<%--                              <p class="narrow text-center">
                      ...
                      <div class="tab-pane fade" id="doner">
                        ...
                        <h3 class="head text-center">Save your shop</h3>
                          <p class="text-center">
