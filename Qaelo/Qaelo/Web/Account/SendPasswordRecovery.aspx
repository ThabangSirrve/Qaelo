<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendPasswordRecovery.aspx.cs" Inherits="Qaelo.Web.Account.SendPasswordRecovery" %>
...
<body>
  ...
  <div class="form">
      ...
      <asp:Button ID="btnSend" style="background:#d89b4e" class="button" runat="server" Text="Send" OnClick="btnSend_Click"/>
   </div>
</div>
    </form>
</body>
