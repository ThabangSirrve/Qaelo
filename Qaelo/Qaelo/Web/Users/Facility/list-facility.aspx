<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Users/Shop/Shop.Master" AutoEventWireup="true" CodeBehind="list-facility.aspx.cs" Inherits="Qaelo.Web.Users.Facility.list_facility" %>
                 ...
                 <li><a href="#messages" data-toggle="tab" >
                     ...
                     <div class="tab-content">
                      <div class="tab-pane fade in active" id="home">
                              <h3 class="head text-center">List Facility</h3>
<%--                              <p class="narrow text-center">
                                ...
                                <div class="row">
                                       <div class="col-sm-7  col-sm-offset-1">
                                           <div class="form-group">
                                                <%--<asp:TextBox ID="txtText" placeholder="Type Tertiary Location" runat="server" type="text" class="typeaheadPlaces tt-query form-control" autocomplete="on" spellcheck="false"></asp:TextBox>--%>
                                           ...
                                           <div class="col-sm-3">
                                             <asp:DropDownList ID="ddlFacility" Width="100%" CssClass="form-control col-sm-3" runat="server" >
                                     ...
                                     <div class="col-sm-5 col-sm-offset-1">
                                      <div class="form-group">
                                          ...
                                          <div class="input-group">
                                              ...
                                              <asp:TextBox ID="txtShoNo" type="text" class="form-control"  placeholder="Facility address" runat="server"></asp:TextBox>
                                          </div>
                                      </div>
                                  </div>
                                     ...
                                     <div class="col-sm-5">
                                      <div class="form-group">
                                          ...
                                          <div class="input-group">
                                              ...
                                              <asp:TextBox ID="txtShopName" class="form-control"  placeholder="Name of the Facility" runat="server"></asp:TextBox>
                                          </div>
                                      </div>
                                  </div>
                              </div>
                      ...
                      <div class="tab-pane fade" id="profile">
                          <h3 class="head text-center">Facility Image</h3>
                          <p class="narrow text-center">
                             Please upload  image for the Facility.
                          </p>
                        <!-- Content here-->
                          <div class="row">
                      ...
                      <div class="tab-pane fade" id="messages">
                              <h3 class="head text-center">Small description about the Facility.</h3>
                          ...
                          <div class="row">
                                    ...
                                    <div class="col-sm-6 col-sm-offset-3">
                                         <div class="form-group">
                                            <label>facility's description</label>
                                           <asp:TextBox ID="txtDescription" class="form-control" placeholder="Facility description. Max 500 words"  runat="server" TextMode="multiline" Width="100%"  Rows="3" ></asp:TextBox>
                                          </div>
                                    </div>
                                </div>
                          <p class="text-center">
                      ...
                      <div class="tab-pane fade" id="doner">
                        ...
                        <h3 class="head text-center">Save your Facility</h3>
                          <p class="text-center">
