<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Users/Society/Society.Master" AutoEventWireup="true" CodeBehind="EditEvent.aspx.cs" Inherits="Qaelo.Web.Users.Society.EditEvent1" %>
                            ...
                            <div class="tab-pane" id="facilities">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-sm-5" >
                                      <div class="form-group"> 
                                          <label>Date</label>                                  
                                          <asp:TextBox ID="txtDate" disabled="" type="date" class="form-control" Width="100%" placeholder="Event Name" runat="server"></asp:TextBox>
                                      </div>
                                  </div>
