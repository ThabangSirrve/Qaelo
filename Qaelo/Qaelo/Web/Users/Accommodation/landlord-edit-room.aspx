<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Users/Accommodation/Accommodation.Master" AutoEventWireup="true" CodeBehind="landlord-edit-room.aspx.cs" Inherits="Qaelo.Web.Users.Accommodation.landlord_edit_room" %>
                 ...
                 <li><a href="#messages" data-toggle="tab" >
                     ...
                     <div class="tab-content">
                      <div class="tab-pane fade in active" id="home">
                              <h3 class="head text-center">Edit  Room</h3>
                      ...
                      <div class="tab-pane fade" id="profile">
                          <h3 class="head text-center">Please upload 5 images of the room available</h3>
                        <!-- Content here-->
                          <div class="row">
...
<%--                          <p class="narrow text-center">
                      ...
                      <div class="tab-pane fade" id="doner">
                        ...
                        <h3 class="head text-center">Save your room updates</h3>
                          <p class="text-center">
