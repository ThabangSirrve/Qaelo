<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Users/Shop/Shop.Master" AutoEventWireup="true" CodeBehind="edit-profile.aspx.cs" Inherits="Qaelo.Web.Users.Facility.edit_profile" %>
                                    ...
                                    <div class="col-sm-7 col-sm-offset-2">
                                         <div class="form-group">
                                            <%--<label>Confirm Password</label>--%>
                                             <asp:Button ID="Button2" class="btn btn-info pull-right" runat="server" Text="update" OnClick="Button2_Click"  />
                                          </div>
                                    </div>
                                </div>
                            <!-- Content here-->
