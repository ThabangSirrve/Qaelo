<%@ Page Title="" Language="C#" MasterPageFile="~/Web/Users/Student/Student.Master" AutoEventWireup="true" CodeBehind="Events.aspx.cs" Inherits="Qaelo.Web.Users.Student.Events" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container thumbnail">
	    <div class="row">
	        <div class="col-md-12"> 
	          <h3 class="text-center">Find your event!</h3>
              <hr/>
            </div>
            <div class="col-md-12">
              <div class="col-sm-6">
